...
//     const makeParam = make || searchParams.get("make") || ""
...
//     if (yearMinParam) params.append("yearMin", yearMinParam) 
...
//   fetchListings()
// }, [make, searchParams.toString(), search, sort, currentPage])
...
//   if (localFilters.model) params.append("model", localFilters.model)
//   if (localFilters.priceMax) params.append("priceMax", localFilters.priceMax)

//   const path = localFilters.make
//     ? `/shop/${localFilters.make}`
//     : "/shop"
...
// <Helmet>
//   <title>
//     {filters.make ? `${filters.make} Cars` : "All Cars"} for Sale | Motoket
//   </title>
//   <meta
//     name="description"
//     content={
//       filters.make && filters.model
//         ? `Find ${filters.make} ${filters.model} cars for sale in ${filters.location || "your area"} at the best prices.`
//         : "Browse all car listings on Motoket. Find premium cars, verified dealers, and best prices."
//     }
//   />
//   <link
//   rel="canonical"
//   href={`https://motoket.com/shop/${filters.make || ""}?${filters.model ? `model=${filters.model}` : ""}`}
// />
...
//           <form onSubmit={handleFilterSubmit} className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 shadow-2xl border border-white/20 dark:border-gray-700/20">
