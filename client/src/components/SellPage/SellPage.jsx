...
//     "Chevrolet", "Lexus", "Land Rover", "Mitsubishi"
//   ];
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="block text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Listing Preview</label>
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700 sticky top-4">
                <div className="relative h-48 bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                  ...
                  <div className="absolute top-3 right-3 bg-yellow-400 text-black font-bold px-3 py-1 rounded-full text-sm shadow-sm">
                ...
                <div className="p-5">
                  ...
                  <div className="flex gap-2 mb-4 flex-wrap">
                    <span className="bg-gray-100 dark:bg-gray-700 text-xs px-2 py-1 rounded text-gray-600 dark:text-gray-300">
                      {formData.mileage ? `${Number(formData.mileage).toLocaleString()} km` : "0 km"}
                    </span>
                    <span className="bg-gray-100 dark:bg-gray-700 text-xs px-2 py-1 rounded text-gray-600 dark:text-gray-300">
                      {formData.transmission || "N/A"}
                    </span>
                    <span className="bg-gray-100 dark:bg-gray-700 text-xs px-2 py-1 rounded text-gray-600 dark:text-gray-300">
                      {formData.fuel_type || "N/A"}
                    </span>
                  </div>
