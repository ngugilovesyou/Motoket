...
from .views import admin_chats, callback_payment,check_email, delete_vehicle, get_featured_vehicles, seller_chats,update_firebase_uid, chat_messages, create_chat, favourite_vehicle, get_admin, get_user, get_user_favourite, get_vehicle_details,get_all_vehicles,capture_paypal_order, create_paypal_order, get_user_vehicles, home, is_favorited, login_admin, make_payment, payment_status,register_user,login_user,delete_user,logout_user, unfavourite_vehicle,  update_vehicle, send_message, join_chat, user_favourite
